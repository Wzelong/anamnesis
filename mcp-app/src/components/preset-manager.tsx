...
// section nav while open. Select collapses it; add / rename / delete keep it open.
        ...
        return (
          ...
          >
            ...
            {renaming ? (
              ...
              <>
                <button onClick={() => onSelect(p.id)} className="flex-1 min-w-0 text-left truncate cursor-pointer">
                  {p.name}
                </button>
