...
def test_none_preset_is_pure_defaults():
    ...
    for rt in RESOURCE_TYPES:
        ...
        assert (
            r.enabled
            and r.coding_systems is None
            and r.prompt_override is None
            and r.extensions == []
        )
...
def test_overrides_applied():
    preset = {
        ...
        "prompts": {
            "Observation": {
                "active_version": 2,
                "versions": [{"version": 1, "text": "old"}, {"version": 2, "text": "new prompt"}],
            }
        },
        "extensions": [
            {"id": "e1", "attach_to": "Condition", "url": "u", "datatype": "string", "name": "x"}
        ],
    }
...
def test_active_prompt_falls_back_to_last_version():
    preset = {
        ...
        "prompts": {
            "Condition": {
                "active_version": 9,
                "versions": [{"version": 1, "text": "v1"}, {"version": 2, "text": "v2"}],
            }
        },
    }
